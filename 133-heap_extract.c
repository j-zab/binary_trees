...
/**
 * tree_height - cecks the height of a binary tree
...
/**
 * _preorder - checks through a binary tree using pre-order traversal
 * @tree: ptr to the root node of the tree to traverse
 * @node: last note to be traversed
 ...
 * @root: a double ptr to the root node of heap
 *
